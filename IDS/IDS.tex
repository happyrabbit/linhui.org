...
Here we consider selection of the tuning parameter \(\lambda\) from a multiplicative grid of 148 values \(\{0.96\lambda_{max},0.96^{2}\lambda_{max},0.96^{3}\lambda_{max},...,0.96^{148}\lambda_{max}\}\), as in Meier et al. \citep{Meier2008}. Here \(\lambda_{max}\) is defined as
