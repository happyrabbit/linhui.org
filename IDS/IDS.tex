...
more certainty. On average, 63.2\% of the sample spots appeared at least
once in a bootstrap sample, so the estimation bias is similar to 2-fold
...
cross-validation. Efron made improvements to the original bootstrap bias
and came up the following 632-method:
