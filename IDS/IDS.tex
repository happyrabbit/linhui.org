...
\hypersetup{
  pdftitle={Practitioner's Guide to Data Science},
...
In 1984, Breiman introduced the Classification and Regression Tree (CART) \index{classification and regression tree}\index{CART}, one of the oldest and most widely used classification and regression techniques \citep{Breiman1984}.

After that, Ross Quinlan developed tree algorithms such as ID3, C4.5, and C5.0. In the 1990s, ensemble techniques, which combine the predictions of many models, began to emerge. Bagging is a general approach that uses bootstrapping in conjunction with regression or classification models to construct an ensemble. Based on the ensemble idea, Breiman came up with the random forest \index{random forest} model in 2001 \citep{Breiman2001}. In the same year, Leo Breiman published a paper ``Statistical Modeling: The Two Cultures'' \citep{Breiman2001TwoCulture}, in which he identified two cultures in the use of statistical modeling to extract information from data:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prediction }\OtherTok{=} \FunctionTok{collect}\NormalTok{(}\FunctionTok{ml\_predict}\NormalTok{(fit2, iris\_tbl))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y }\OtherTok{\textless{}{-}}\NormalTok{ sim.dat}\SpecialCharTok{$}\NormalTok{income}
\NormalTok{yhat }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fit, sim.dat)}
\NormalTok{MSE }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{((y }\SpecialCharTok{{-}}\NormalTok{ yhat)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{, }\AttributeTok{na.rm =}\NormalTok{ T )}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-73-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-76-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-82-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-97-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-115-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-119-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-126-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-133-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-139-1.pdf}
...
\CommentTok{\# check outcome balance}
\FunctionTok{table}\NormalTok{(dat}\SpecialCharTok{$}\NormalTok{gender) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{prop.table}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
The outcome is pretty balanced, with 55\% female and 45\% male. We use \texttt{train()} function in \texttt{caret} package to call \texttt{rpart} to build the model. We can compare the model results from the two approaches:
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-146-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-154-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-157-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Convert tf.tensor to array}
\NormalTok{dnn\_pred }\OtherTok{\textless{}{-}} \FunctionTok{as.array}\NormalTok{(dnn\_pred)}
...
\begin{Highlighting}[]
\NormalTok{\#\# List of 2}
\NormalTok{\#\#  $ params :List of 3}
\NormalTok{\#\#   ..$ verbose: int 1}
\NormalTok{\#\#   ..$ epochs : int 10}
\NormalTok{\#\#   ..$ steps  : int 375}
\NormalTok{\#\#  $ metrics:List of 4}
\NormalTok{\#\#   ..$ loss        : num [1:10] 0.3415 0.0911 0.0648 0.0504 0.0428 ...}
\NormalTok{\#\#   ..$ accuracy    : num [1:10] 0.891 0.973 0.981 0.985 0.987 ...}
\NormalTok{\#\#   ..$ val\_loss    : num [1:10] 0.071 0.0515 0.0417 0.0377 0.0412 ...}
\NormalTok{\#\#   ..$ val\_accuracy: num [1:10] 0.978 0.985 0.988 0.99 0.988 ...}
\NormalTok{\#\#  {-} attr(*, "class")= chr "keras\_training\_history"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\DocumentationTok{\#\# Convert tf.tensor to array}
\NormalTok{cnn\_pred }\OtherTok{\textless{}{-}} \FunctionTok{as.array}\NormalTok{(cnn\_pred)}
