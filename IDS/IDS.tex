...
To compare different models, we need a way to measure model performance. There are various metrics to use. Sometimes, it is better to look at models through multiple lenses. In this chapter, we will introduce some of the most common performance measurement metrics. You need to select a performance measurement when tuning the model.
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-104-1.pdf}
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-122-1.pdf}
