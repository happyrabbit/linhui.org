...
Fig. \ref{fig:maxdis} shows 100 simulated time series observation. The
...
clear about the argument \texttt{fixedWindow\ =}, try to change the
setting to be \texttt{F} and check the change in \texttt{trainSlices}
and \texttt{testSlices}.
