...
Current step shed new light on what to do next. Sometimes you also need
to go back to fix something in the previous steps. For example, you may
need to check those negative expense value.
...
\includegraphics{IDS_files/figure-latex/unnamed-chunk-74-1.pdf}
