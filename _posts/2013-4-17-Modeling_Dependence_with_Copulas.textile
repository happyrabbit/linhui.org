...
The set Γ(F1, ..., Fd) is called the Frechet class of the Fj′s. Notice Γ(F1, ..., Fd) ̸= ∅ since, if X1, X2, ..., Xd are independent, then  H (x1 , x2 , ..., xd )=F1(x1) * F2(x2)* ... *Fd(xd). 
...
The PDF version of the report can be found <a href="http://linhui.org/works/ModelingDependence_with_Copulas_TheoryApplications.pdf" target="_blank">HERE</a>. The last update is on December 3, 2012.
