...
<li>0.05 = α = P[reject H0 for test one | H0 is true for test one]</li>
...
<li>α_t = P[reject H0 for one of the k tests | H0 is true for all tests]</li>
...
<li>α_t= 1−(1−α)(1−α)· · · (1−α)	= 1 − (1−α)^k</li>
