...
The PDF version of the report can be found <a href="http://hui1987.com/works/ModelingDependence_with_Copulas_TheoryApplications.pdf" target="_blank">"Modeling Dependence with Copulas: Theory and Applications, Quo Vadis?"</a>. The last update is on December 3, 2012.
